...
?>
<ul class="snav">
	<li id="sb_pages" ><a href="system.php" accesskey="<?php echo find_accesskey(i18n_r('SIDE_VIEW_SYSTEM'));?>" <?php check_menu('system');  ?>><?php i18n('SIDE_VIEW_SYSTEM'); ?></a></li>
	...
	<?php exec_action("system-sidebar"); ?>
</ul>
